...
const Sidebar = ({ isOpen, setIsOpen }) => {
	...
	return (
		<>
			...
			<div
				className={`fixed inset-y-0 left-0 z-50 w-64 h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-2xl flex flex-col transform transition-transform duration-300 ease-in-out md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>

				{/* Header */}
				<div className='px-6 py-5 border-b border-slate-700/50 bg-slate-900/50 flex items-center justify-between'>
