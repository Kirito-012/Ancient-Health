...
import { blogCache, getBlogImageAlt } from '../utils/blogUtils'
                                    ...
                                    <div className="relative h-72 lg:h-auto overflow-hidden bg-[#1B2B26]">
                                        {featuredBlog.image ? (
                                            <img
                                                ...
                                                alt={getBlogImageAlt(featuredBlog, featuredBlog.title || 'Featured blog image')}
                                                title={featuredBlog.title}
                                    ...
                                    >
                                        ...
                                        <div className="relative h-52 overflow-hidden bg-[#1B2B26]">
                                            {blog.image ? (
                                                <img
                                                    src={blog.image}
                                                    alt={getBlogImageAlt(blog, blog.title || 'Blog card image')}
                                                    title={blog.title}
