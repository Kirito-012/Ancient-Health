...
import { blogCache, getBlogImageAlt, getBlogInfographicAlt } from '../utils/blogUtils'
                        ...
                        <div className="absolute inset-0">
                            {blog.image ? (
                                <motion.img
                                    ...
                                    src={blog.image}
                                    alt={getBlogImageAlt(blog, blog.title || 'Blog hero image')}
                                    title={blog.title}
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="my-10 rounded-2xl overflow-hidden border border-[#d4a574]/20 shadow-md">
                                                            <img
                                                                ...
                                                                alt={getBlogInfographicAlt(blog, blog.title ? `${blog.title} infographic` : 'Blog infographic')}
                                                                title={getBlogInfographicAlt(blog, blog.title ? `${blog.title} infographic` : 'Blog infographic')}
                                            ...
                                            >
                                                <div className="h-40 bg-[#1B2B26] overflow-hidden">
                                                    {item.image ? (
                                                        <img
                                                            src={item.image}
                                                            alt={getBlogImageAlt(item, item.title || 'Recent blog image')}
                                                            title={item.title}
